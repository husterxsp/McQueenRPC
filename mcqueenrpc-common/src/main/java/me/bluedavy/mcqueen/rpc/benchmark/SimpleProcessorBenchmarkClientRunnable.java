...
public class SimpleProcessorBenchmarkClientRunnable implements ClientRunnable {
    ...
    public SimpleProcessorBenchmarkClientRunnable(ClientFactory factory,
                                                  String targetIP, int targetPort, int clientNums, int rpcTimeout, int codecType,
    ...
    private void runJavaAndHessian() {
        while (running) {
            ...
            try {
                ...
                response = factory.get(targetIP, targetPort, 1000, clientNums)
                        .invokeSync(requestObject, rpcTimeout, codecType, SimpleProcessorProtocol.TYPE);
